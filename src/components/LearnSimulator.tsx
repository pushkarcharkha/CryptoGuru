...
import { 
    ...
    ShieldCheck, ChevronRight, MessageSquare, Brain
} from 'lucide-react';
...
type SimulationPhase = 'concept' | 'task' | 'decision' | 'simulation' | 'result';

export const LearnSimulator: React.FC<LearnSimulatorProps> = ({ lesson, onBack, onComplete, onNextLesson }) => {
            ...
            <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
                ...
                <div style={{ 
                    ...
                    <section style={{ opacity: phase === 'concept' ? 1 : 0.4, transition: 'all 0.3s' }}>
                        ...
                        <p style={{ color: '#94a3b8', lineHeight: 1.6, fontSize: '14px', marginBottom: '20px' }}>{lesson.explanation || lesson.theory}</p>
