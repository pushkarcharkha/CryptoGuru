...
export default function LandingPage({ onLaunch }: LandingProps) {
  ...
  // Initialize Locomotive Scroll & custom cursor
  useEffect(() => {
    ...
    // We link Locomotive with ScrollTrigger so triggers fire properly when scrolling natively
    // In Locomotive v4/v5 this isn't strictly necessary if it just uses native scroll, but we'll refresh ST.
    setTimeout(() => {
  ...
  useGSAP(() => {
    ...
    // Problem Cards GSAP
    gsap.from('.problem-section .feature-card', {
      scrollTrigger: {
  ...
  return (
    <div ref={containerRef} style={{ background: '#050508', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      
      {/* SECTION 1 — Hero */}
      <section style={{ height: '100vh', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: '800px', padding: '0 20px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(56px, 8vw, 96px)', fontWeight: 800, lineHeight: 1.05, marginBottom: '24px', letterSpacing: '-0.03em' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
            <button className="btn-primary hero-cta" style={{ fontSize: '18px', padding: '16px 36px' }} onClick={onLaunch}>
              Launch App →
            </button>
            <button className="btn-outline hero-cta" style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '18px', padding: '16px 36px' }}>
      ...
      <section className="section" style={{ padding: '80px 5%' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto', alignItems: 'center' }}>
          ...
          <div className="pricing-card">
            ...
            <button className="btn-outline" style={{ marginTop: 'auto', width: '100%' }}>Get Started</button>
          </div>
          ...
          <div className="pricing-card popular" style={{ position: 'relative', minHeight: '520px' }}>
            ...
            <button className="btn-primary" style={{ marginTop: 'auto', width: '100%' }}>Start Pro →</button>
          </div>
          ...
          <div className="pricing-card">
            ...
            <button className="btn-outline" style={{ marginTop: 'auto', width: '100%' }}>Go Pro+ →</button>
          </div>
